...
<title>Energy Sector – Bangladesh National Emission Inventory</title>
...
<div class="page">
  ...
  <a class="back-link" href="../index.html">&larr; All Sectors</a>
  ...
  <div class="tab-panel active" id="dataset">
    ...
    <ul class="download-list">
      <li><a href="../data/energy_1A1_2023.xlsx">energy_1A1_2023.xlsx</a> — Energy industries combustion calculations</li>
      <li><a href="../data/energy_1A3_2023.xlsx">energy_1A3_2023.xlsx</a> — Transport sector calculations</li>
    </ul>
  ...
  <div class="tab-panel" id="methodology">
    ...
    <p class="muted">See also the <a href="../methodology.html">overall cross-sector methodology</a> for QA/QC and uncertainty approach.</p>
  </div>
  ...
  <div class="tab-panel" id="map">
    ...
    <p class="muted">
      ...
      <a href="https://environmentalintegrity.org/state-emissions-inventory/" target="_blank">Environmental Integrity Project's state emissions inventory map</a>
      — clickable/hoverable spatial data linking to underlying source information.
    </p>
    <div class="map-box">
      <!-- Replace this block with an <video> or <iframe> embed once available, e.g.:
      <video controls>
  ...
  <div class="tab-panel" id="literature">
    ...
    <p class="muted">See also the sector-wide <a href="../emission-factors.html">Emission Factors &amp; Guidebooks</a> page.</p>
  </div>
